...
(function(exports) {
  ...
  var encodeJsonOrder = new Data_Argonaut_Encode_Class.EncodeJson(Data_Argonaut_Encode_Class.gEncodeJson(genericOrder));
  exports["Order"] = Order;
...
(function(exports) {
      ...
      return function (dictMonadError) {
          return function (a) {
              return Data_Either.either(function (err) {
                  return Control_Monad_Error_Class.throwError(dictMonadError)(Control_Monad_Eff_Exception.error(err));
              })(function (p) {
                  return Control_Applicative.pure((dictMonadError["__superclass_Control.Monad.Monad_0"]())["__superclass_Control.Applicative.Applicative_0"]())((function () {
                      var $15 = {};
                      for (var $16 in a) {
                          if ({}.hasOwnProperty.call(a, $16)) {
                              $15[$16] = a[$16];
                          };
                      };
                      $15.body = p;
  ...
  var parseQueryParams = function (dictDecodeJson) {
      return function (dictMonadError) {
          return function (v) {
              return Data_Maybe.maybe(Control_Monad_Error_Class.throwError(dictMonadError)(Control_Monad_Eff_Exception.error("No params found")))(function (p) {
                  return Data_Either.either(function ($40) {
                      return Control_Monad_Error_Class.throwError(dictMonadError)(Control_Monad_Eff_Exception.error($40));
                  })(Control_Applicative.pure((dictMonadError["__superclass_Control.Monad.Monad_0"]())["__superclass_Control.Applicative.Applicative_0"]()))(Control_Bind.composeKleisli(Data_Either.bindEither)(function ($41) {
                      return Data_Argonaut_Parser.jsonParser(Global["decodeURI"]($41));
...
(function(exports) {
  ...
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];        
  var myOrders = [ new EndpointExample_Model.Order({
      productId: 1, 
      quantity: 50
  }), new EndpointExample_Model.Order({
      productId: 2, 
      quantity: 6
  }) ];
  ...
  var main = function __do() {
      ...
      Node_Express_Endpoint.hostEndpoint(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.decodeJsonNull)(Data_Argonaut_Encode_Class.encodeJsonArray(EndpointExample_Model.encodeJsonOrder))(v)(EndpointExample_Model.getOrdersEndpoint)(function (productId) {
          return function (v1) {
              return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(filterOrders(productId));
          };
      })();
      Node_Express_Endpoint.hostStatic(v)("static")();
...
})(PS["EndpointExample.Server"] = PS["EndpointExample.Server"] || {});
PS["EndpointExample.Server"].main();
